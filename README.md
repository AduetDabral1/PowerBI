...
Welcome to my Power BI projects repository! This collection serves as a comprehensive portfolio of end-to-end data analytics solutions. Each project highlights the complete data lifecycle—from **Automated Extraction** (APIs & Web Scraping) and **Advanced Modeling** (Medallion Architecture) to **Complex DAX Engineering** and **Interactive UI/UX Design**.
...
<img width="500" height="500" alt="Screenshot 2026-05-05 103422" src="https://github.com/user-attachments/assets/69de6f19-e827-4bc6-85ff-92663dfdec2f" />
</a>
...
<img width="500" height="500" alt="Screenshot 2026-04-20 082938" src="https://github.com/user-attachments/assets/7ae3fd1b-4876-4950-96d8-9c2dea2b997f" />
</a>
...
<img width="500" height="500" alt="Screenshot 2026-05-05 110504" src="https://github.com/user-attachments/assets/6cc2ff34-2c3a-4ed4-96f0-f73ea0d3e637" />
</a>
...
<img width="500" height="500" alt="Olympics Dashboard" src="https://github.com/user-attachments/assets/81994fca-7c06-4bf1-9a2c-13320237906a" />
</a>
...
<img width="500" height="500" alt="Finance Dashboard" src="https://github.com/user-attachments/assets/62fbc6df-b16c-4825-b7d4-26618470e772" />
</a>
...
<img width="500" height="500" alt="YouTube Dashboard" src="https://github.com/user-attachments/assets/bd09a249-5f4d-4ac2-ac79-d415a143988d" />
</a>
...
<img width="500" height="500" alt="Spotify Dashboard" src="https://github.com/user-attachments/assets/e121459c-7917-4f44-a146-24ab5eeb642b" />
</a>
...
<img width="500" height="500" alt="Supply Chain Dashboard" src="https://github.com/user-attachments/assets/cbc73354-d884-4cc0-8e89-aacf5fedcfc8" />
</a>
...
<img width="500" height="500" alt="Honda Sales Dashboard" src="https://github.com/user-attachments/assets/e10612bb-7fc4-4115-a7e0-ac1abc8fafdd" />
</a>
---
...
* **Power Query (M-Code):** Expertise in connecting to **REST APIs**, web scraping, and complex data transformations.
* **Data Modeling:** Proficiency in designing **Star Schemas**, handling granularity mismatches, and managing many-to-many relationships.

### DAX & Analytics
* **Advanced DAX:** Time Intelligence (YTD, MoM, YoY), `CALCULATE` logic, `SWITCH` for dynamic visual selections, and `ALLSELECTED` for custom granularity.
...
```text
├── Finance Dashboard         # Personal finance .pbix and data files
├── Google Trends Dashboard   # Global search interest analysis
├── Honda                     # Automotive sales & service analysis
├── IPL 2026 Dashboard        # Live API-integrated cricket analytics
├── Market Dashboard         # Stock market and sector analysis
├── Olympics Dashboard        # Historical & Paris 2024 sports data viz
├── Spotify Dashboard         # Music trend analytics
├── Supply Chain Dashboard    # Logistics & Operations metrics
